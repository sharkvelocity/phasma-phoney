// mechanics.js – Ghost activity, sanity, evidence, cursed items with stats tracking

import { updateStats, recordSanityLoss, incrementCursedItemUse, addEvidenceFound } from './statistics.js';
